...
exports.verifyToken = exports.isModerator = exports.isAdmin = exports.authRequired = void 0;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          token = req.cookies.token; // si no hay un token y no hay nada, se retorna error
          if (token) {
            _context2.next = 4;
            break;
          }
...
var isModerator = exports.isModerator = /*#__PURE__*/function () {
  ...
  return function isModerator(_x5, _x6, _x7) {
